...
Pass one library_dir (default `plugins/skill-workshop/skills`) for the
...
_validate_spec = importlib.util.spec_from_file_location(
    "skill_workshop_validate", _HERE / "validate.py"
)
...
sys.modules["skill_workshop_validate"] = _validate
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="One or more library paths (default: plugins/skill-workshop/skills). "
