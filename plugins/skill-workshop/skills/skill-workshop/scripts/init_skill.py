...
`plugins/skill-workshop/skills/` and had to be moved by hand. Only when
none of those apply does it fall back to `plugins/skill-workshop/skills`.
"""
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "exists, else plugins/skill-workshop/skills)"
        ),
    )
    parser.add_argument(
        "--plugin",
    ...
    if args.library:
        ...
        # into the marketplace layout there creates plugins/skill-workshop/skills/
        # from nothing and has to be moved by hand.
        library_root = ".claude/skills"
    else:
        library_root = "plugins/skill-workshop/skills"
