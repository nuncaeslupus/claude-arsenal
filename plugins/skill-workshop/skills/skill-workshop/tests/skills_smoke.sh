...
#
# Usage:
#   bash plugins/skill-workshop/skills/skill-workshop/tests/skills_smoke.sh
#   bash plugins/skill-workshop/skills/skill-workshop/tests/skills_smoke.sh --severity warn

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "$SCRIPT_DIR/../../../../.." && pwd)"
AUDIT="$REPO_ROOT/plugins/skill-workshop/skills/skill-workshop/scripts/audit_library.py"
