...
|----|-------------|---------|------|---------|------|-------|
| T1 | <description> | <service> | S/M/L | — | `<metric> <op> <threshold>` | `test_<what>_<cond>_<expected>` in `<file>` — <one-sentence assertion> |
| T2 | <description> | <service> | S/M/L | T1 | `<metric> <op> <threshold>` | `test_<what>_<cond>_<expected>` in `<file>` — <one-sentence assertion> |
| T3 | <description> | <service> | S/M/L | T1 | `<metric> <op> <threshold>` | `test_<what>_<cond>_<expected>` in `<file>` — <one-sentence assertion> |
| T4 | <description> | <service> | S/M/L | T2, T3 | `<metric> <op> <threshold>` | `test_<what>_<cond>_<expected>` in `<file>` — <one-sentence assertion> |
