---
name: init
description: When the user needs claude-arsenal/ set up in a host repo. Supports --workspace to register a new workspace. Re-running is safe — refreshes stale bundle files only.
user-invocable: true
